...
setuptools.setup(
    ...
    project_urls={
        "Bug Tracker": "https://github.com/denisvasilik/binalyzer-patch/issues/",
        "Documentation": "https://binalyzer.readthedocs.io/en/latest/",
        "Source Code": "https://github.com/denisvasilik/binalyzer-patch/",
    },
    ...
    dependency_links=[],
    package_dir={"binalyzer_patch": "binalyzer_patch"},
    package_data={},
    ...
    entry_points='''
        [binalyzer.commands]
        patch=binalyzer_patch.cli:patch
    ''',
)
